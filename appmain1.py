...
def preprocess_excel(file_path, output_file_path):
    ...
    # Check if file needs to be converted to .xlsx
    #_, ext = os.path.splitext(file_path)
    #if ext.lower() in ['.xls', '.csv']:
    #    intermediate_path = file_path + 'x'  # change extension to .xlsx
    #    convert_to_xlsx(file_path, intermediate_path)
    #    file_path = intermediate_path  # Update file path to new .xlsx file

        #if file_extension.lower() == '.csv':
            # Read CSV and save as XLSX
        #    print("2")
        ...
        #    print("3")
        #    print("Temp path :",temp_path)
        #    # Read XLS and save as XLSX
        #    df = pd.read_excel(file_path)
        #    df.to_excel(temp_path, index=False, engine='openpyxl')
        #file_path = temp_path  # Update file_path to the new XLSX file
